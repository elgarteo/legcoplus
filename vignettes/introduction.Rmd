...
These are the messages created when the function is making multiple requests to the APIs.
The actual number of records in the output data frame is displayed in the last message.
...
search_member(name = "謙")

# Lookup members with "ting" in their names
search_member(name = "ting")
```

By default, `search_member()` returns the closest 
