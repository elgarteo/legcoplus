...
The searching parameters of `search_member()` are the same with that of `search_committee()` 
such as the exact match option. Refer [here](#search_committee) for detailed examples.
